...
urlpatterns = [
    ...
    path("<int:pk>/foto/", PersonaFotoDownloadView.as_view(), name="personas-foto"),
    ...
    path("adultos/<int:pk>/certificado/", AdultoCertificadoDownloadView.as_view(), name="adultos-certificado"),
    ...
    path("beneficiarios/<int:pk>/asignacion/", BeneficiarioAsignacionView.as_view(), name="beneficiarios-asignacion"),
