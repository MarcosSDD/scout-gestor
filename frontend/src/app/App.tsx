...
import {
  ...
  OwnPersonaPage,
  PersonaDetailPage,
} from "../features/personas/PersonaDetailPages";
import {
  AdultosPage,
  ApoderadosPage,
  BeneficiariosPage,
} from "../features/personas/PersonasPages";
import {
  AsignacionFormPage,
  BeneficiarioFormPage,
  CertificadoFormPage,
  PersonaFormPage,
} from "../features/personas/PersonaForms";
import {
  ProgresionFormPage,
  ProgresionesPage,
} from "../features/personas/ProgresionPages";
...
function StructuralPage({
  ...
  page: "unidad" | "subgrupo" | "miembro" | "adulto";
}) {
  return (
...
const LazyUnidadForm = lazy(async () => ({
  default: (await import("../features/unidades/StructuralForms"))
    .UnidadFormPage,
}));
const LazySubgrupoForm = lazy(async () => ({
  default: (await import("../features/unidades/StructuralForms"))
    .SubgrupoFormPage,
}));
const LazyMiembroForm = lazy(async () => ({
  default: (await import("../features/unidades/StructuralForms"))
    .MiembroFormPage,
}));
const LazyAdultoForm = lazy(async () => ({
  default: (await import("../features/unidades/StructuralForms"))
    .AdultoRolFormPage,
}));
...
function App() {
  return (
    <Routes>
      ...
      />
      <Route
        path="/app/unidades/nueva"
        element={
          <RequireAuth>
            <AppPage navItemId="unidades">
              <StructuralPage page="unidad" />
            </AppPage>
          </RequireAuth>
        }
      />
      ...
      />
      <Route
        path="/app/unidades/:unidadId/editar"
        element={
          <RequireAuth>
            <AppPage navItemId="unidades">
              <StructuralPage page="unidad" />
      ...
      />
      <Route
        path="/app/unidades/:unidadId/subgrupos/nuevo"
        element={
          <RequireAuth>
            <AppPage navItemId="unidades">
              <StructuralPage page="subgrupo" />
            </AppPage>
          </RequireAuth>
        }
      />
      <Route
        path="/app/unidades/:unidadId/adultos/nuevo"
        element={
          <RequireAuth>
            <AppPage navItemId="unidades">
              <StructuralPage page="adulto" />
            </AppPage>
          </RequireAuth>
        }
      />
      <Route
        path="/app/unidades/:unidadId/subgrupos/:subgrupoId/miembros/nuevo"
        element={
          <RequireAuth>
            <AppPage navItemId="unidades">
              <StructuralPage page="miembro" />
            </AppPage>
          </RequireAuth>
        }
      />
      <Route
        path="/app/unidades/subgrupos/:subgrupoId/editar"
        element={
          <RequireAuth>
            <AppPage navItemId="unidades">
              <StructuralPage page="subgrupo" />
      ...
      />
      <Route
        path="/app/unidades/miembros/:miembroId/reasignar"
        element={
          <RequireAuth>
            <AppPage navItemId="unidades">
              <StructuralPage page="miembro" />
      ...
      />
      <Route
        path="/app/unidades/adultos/:asignacionId/editar"
        element={
          <RequireAuth>
            <AppPage navItemId="unidades">
              <StructuralPage page="adulto" />
      ...
      >
        ...
        <Route
          path="adultos/:adultoId/certificado"
          element={<CertificadoFormPage />}
        />
        <Route path="beneficiarios" element={<BeneficiariosPage />} />
        <Route
          path="beneficiarios/:beneficiarioId/editar"
          element={<BeneficiarioFormPage />}
        />
        <Route
          path="beneficiarios/:beneficiarioId/asignacion"
          element={<AsignacionFormPage />}
        />
        <Route
          path="beneficiarios/:beneficiarioId/progresiones"
          element={<ProgresionesPage />}
        />
        <Route
          path="beneficiarios/:beneficiarioId/progresiones/nuevo"
          element={<ProgresionFormPage />}
        />
        <Route
          path="beneficiarios/:beneficiarioId/progresiones/:progresionId/editar"
          element={<ProgresionFormPage />}
        />
        <Route path="apoderados" element={<ApoderadosPage />} />
        <Route
          path="apoderados/:apoderadoId"
          element={<ApoderadoDetailPage />}
        />
        ...
        element={
          <RequireAuth>
            <AppPage navItemId="formacion">
              <PlaceholderPage
                title="Formacion"
                description="El modulo de formacion estara disponible proximamente."
              />
            </AppPage>
          </RequireAuth>
        }
