...
describe('CircularActionLink', () => {
  it('renders an accessible circular link with a tooltip', () => {
    renderWithQueryClient(<MemoryRouter><CircularActionLink to="/app/unidades/nueva" label="Nueva unidad" /></MemoryRouter>)

    expect(screen.getByRole('link', { name: 'Nueva unidad' })).toHaveAttribute('href', '/app/unidades/nueva')
