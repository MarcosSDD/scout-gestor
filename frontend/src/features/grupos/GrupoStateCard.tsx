...
export function GrupoStateCard({
  title,
  message,
  error,
  onRetry,
  ...
  return (
    <article
      className="home-card grupos-state-card"
    ...
    >
      ...
      <p>
        {isUnauthorized
          ...
          : isNotFound
            ? "El grupo no existe o ya no esta disponible para tu perfil."
            : isDenied
              ? "El backend no permite ver este grupo."
              : message}
      </p>
